          ...
          <ScrollView style={{flex:1,backgroundColor:'#fff',flexDirection:'column'}}>
              ...
              <View style={{flex:2,flexDirection:'column',backgroundColor:'#fff',paddingTop:10,paddingHorizontal:'3%'}} >
                  <View style={{flexDirection:'row',justifyContent:'flex-start',alignItems:'center'}} >
                      <Image source={require('./src/assets/images/waving_hand.png')} style={{width:30,height:30}}  />
                                            <Text style={{fontFamily:'OpenSans-SemiBold',fontSize:30,color:Colors.black}} > GeoMorada</Text>

                  </View>
                  <Text style={{fontFamily:"OpenSans-Regular",fontSize:14,paddingTop:10,color:"#777"}} >Estou feliz em te ver novamente. Voce pode continuar de onde voçe parou fazendo o login aqui.</Text>
              ...
              <View style={{flex:2,backgroundColor:'#fff',flexDirection:'column',paddingHorizontal:'3%'}} >
                  ...
                  <View style={{flexDirection:'column',alignItems:'center',width:'95%'}} >
                      <TouchableOpacity onPress={()=>console.log("google login")} style={styles.social_btn} >
                          <Image style={styles.social_img} source={require('./src/assets/images/google_icon.png')} />
                      ...
                      <TouchableOpacity onPress={()=>console.log("facebook login")} style={styles.social_btn} >
                          <Image style={styles.social_img} source={require('./src/assets/images/facebook_icon.png')} />
